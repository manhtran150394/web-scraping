...
class SsvscarperSpiderMiddleware:
...
class SsvscarperDownloaderMiddleware:
    # Not all methods need to be defined. If a method is not defined,
...
class SsvscraperFakeUserAgentMiddleware:
    @classmethod
    def from_crawler(cls, crawler):
...
class SsvscraperFakeBrowserHeaderAgentMiddleware:
    ...
    def process_request(self, request, spider):        
        ...
        print("************ NEW BROWSER HEADER ATTACHED *******")
        print(request.headers)        

class SsvscraperProxyMiddleware(object):
